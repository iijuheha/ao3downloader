...
Filename customization is here! You can change the filename pattern by editing the file <!--CHECK-->settings.ini<!--INI_FILE_NAME--> (instructions are in the file). If you don't wish to customize filenames, you can just not change anything and the program will continue to work the same way.
